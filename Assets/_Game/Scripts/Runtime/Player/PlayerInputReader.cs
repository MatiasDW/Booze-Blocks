...
namespace BoozeBlocks.Player
{
    ...
    public sealed class PlayerInputReader : MonoBehaviour
    {
        ...
        public bool InteractPressed => interactPressedFrame == Time.frameCount || WasPressed(interactAction) ||
            (Keyboard.current != null && Keyboard.current.eKey.wasPressedThisFrame);
        public bool UseItemPressed => useItemPressedFrame == Time.frameCount || WasPressed(useItemAction) ||
            (Keyboard.current != null && Keyboard.current.fKey.wasPressedThisFrame);
        public bool DrinkPressed => drinkPressedFrame == Time.frameCount || WasPressed(drinkAction) ||
            (Keyboard.current != null && Keyboard.current.qKey.wasPressedThisFrame);
        public bool JumpPressed => jumpPressedFrame == Time.frameCount || WasPressed(jumpAction);
